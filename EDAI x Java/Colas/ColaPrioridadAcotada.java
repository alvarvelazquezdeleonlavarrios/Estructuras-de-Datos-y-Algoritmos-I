public class ColaPrioridadAcotada {

	public Nodo inicio, fin;
	public int tamaño, tamMax;

	// Constructor de la Cola
	public ColaPrioridadAcotada(int tamMax){
		this.inicio = null;
		this.fin = null;
		this.tamaño = 0;
		this.tamMax = tamMax;
	...
	public static void main(String[] args){
		ColaPrioridadAcotada cola = new ColaPrioridadAcotada(4);
		Nodo tmp;
	...
	public Nodo pop(){
		...
		if (tamaño==0 && inicio==null && fin==null){
			System.out.println("\nError: no hay elementos en la Cola de Prioridad Acotada\n");
	...
	public void imprimirCola(){
		...
		if (tamaño==0 && inicio==null && fin==null){
			System.out.println("\nCola de Prioridad Acotada sin elementos");
