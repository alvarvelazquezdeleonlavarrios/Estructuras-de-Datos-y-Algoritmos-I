public class ListaLigadaInversa {

	public Nodo inicio, fin;
	public int tamaño;

	// Constructor de la Lista
	public ListaLigadaInversa(){
		this.inicio = null;
		this.fin = null;
		this.tamaño = 0;
	}
	...
	public static void main(String[] args){
		ListaLigadaInversa lista = new ListaLigadaInversa();
		Nodo tmp;
		int ind;
	...
	public void addInicio(Nodo nodo){
		...
		while (tmp != null){
			tmp.indice = cont; // Modifica el valor de los índices
			tmp = tmp.anterior;
			cont--;
		}
	...
	public void remove(Nodo nodo){
		...
		if (tamaño==0 && inicio==null && fin==null){
			...
			if (encontrado == false){
				System.out.println("Nodo no encontrado en la Lista Ligada Inversa");
